...
import {
 validateLogin, validateNameRegistration, validateEmailRegistration, validatePassword
} from '../../utils';
        ...
        <div className={styles.register_card}>
          ...
          <div className={styles.card_body}>
            ...
            <p className={`montserrat-regular ${styles.login_link}`}>
              ...
              {' '}
              <button className={styles.linkBtn} onClick={() => setIsModalOpen(true)}>Sign in</button>
            </p>
          </div>
        </div>
        <SigninModal
